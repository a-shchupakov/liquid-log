...
public class HistoryController
{
    ...
    {
        return getDataAndViewByDate(client, SdngParseMode.SdngDataType.RESPONSE, year, month, day, HISTORY_VIEW);
    }
    ...
    public ModelAndView actionsByDay(@PathVariable("client") String client,
            ...
            @PathVariable(name = "day", required = false) int day) throws ParseException
    {
        return getDataAndViewByDate(client, SdngParseMode.SdngDataType.ACTIONS, year, month, day, ACTIONS_VIEW);
    }
    ...
    public ModelAndView gcByDay(@PathVariable("client") String client,
            ...
            @PathVariable(name = "day", required = false) int day) throws ParseException
    {
        return getDataAndViewByDate(client, GCParseMode.GCDataType.GARBAGE_COLLECTION, year, month, day, GC_VIEW);
    }
    ...
    public ModelAndView topByDay(@PathVariable("client") String client,
            ...
            @PathVariable(name = "day", required = false) int day) throws ParseException
    {
        return getDataAndViewByDate(client, TopParseMode.TopDataType.TOP, year, month, day, CPU_VIEW);
    }
    ...
    {
        return getDataAndViewByDate(client, SdngParseMode.SdngDataType.RESPONSE, year, month, 0, HISTORY_VIEW, true);
    }
    ...
    public ModelAndView actionsByMonth(@PathVariable("client") String client,
            ...
            @PathVariable(name = "month", required = false) int month) throws ParseException
    {
        return getDataAndViewByDate(client, SdngParseMode.SdngDataType.ACTIONS, year, month, 0, ACTIONS_VIEW, true);
    }
    ...
    public ModelAndView gcByMonth(@PathVariable("client") String client,
            ...
            @PathVariable(name = "month", required = false) int month) throws ParseException
    {
        return getDataAndViewByDate(client, GCParseMode.GCDataType.GARBAGE_COLLECTION, year, month, 0, GC_VIEW, true);
    }
    ...
    public ModelAndView topByMonth(@PathVariable("client") String client,
            ...
            @PathVariable(name = "month", required = false) int month) throws ParseException
    {
        return getDataAndViewByDate(client, TopParseMode.TopDataType.TOP, year, month, 0, CPU_VIEW, true);
    }
    ...
    {
        ru.naumen.perfhouse.statdata.StatData d = service.getData(client, SdngParseMode.SdngDataType.RESPONSE, count);
    ...
    public ModelAndView gcLast864(@PathVariable("client") String client,
            @RequestParam(name = "count", defaultValue = "864") int count) throws ParseException
    {
        return getDataAndView(client, GCParseMode.GCDataType.GARBAGE_COLLECTION, count, GC_VIEW);
    ...
    public ModelAndView actionsLast864(@PathVariable("client") String client,
            @RequestParam(name = "count", defaultValue = "864") int count) throws ParseException
    {
        return getDataAndView(client, SdngParseMode.SdngDataType.ACTIONS, count, ACTIONS_VIEW);
    }
    ...
    public ModelAndView topLast864(@PathVariable("client") String client,
            @RequestParam(name = "count", defaultValue = "864") int count) throws ParseException
    {
        return getDataAndView(client, TopParseMode.TopDataType.TOP, count, CPU_VIEW);
    }
    ...
    {
        return getDataAndViewCustom(client, SdngParseMode.SdngDataType.RESPONSE, from, to, maxResults, HISTORY_VIEW);
    }
    ...
    {
        return getDataAndViewCustom(client, SdngParseMode.SdngDataType.ACTIONS, from, to, count, ACTIONS_VIEW);
    }
    ...
    public ModelAndView customGc(@PathVariable("client") String client, @RequestParam("from") String from,
            @RequestParam("to") String to, @RequestParam("maxResults") int count) throws ParseException
    {
        return getDataAndViewCustom(client, GCParseMode.GCDataType.GARBAGE_COLLECTION, from, to, count, GC_VIEW);
    }
    ...
    public ModelAndView customTop(@PathVariable("client") String client, @RequestParam("from") String from,
            @RequestParam("to") String to, @RequestParam("maxResults") int count) throws ParseException
    {
        return getDataAndViewCustom(client, TopParseMode.TopDataType.TOP, from, to, count, CPU_VIEW);
    }
